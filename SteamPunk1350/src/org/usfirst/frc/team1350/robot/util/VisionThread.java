	...
	public void run() {
		...
		while (!Thread.interrupted()) {
			...
			for (int i = 0; i < filterContoursOutput.size(); i++) {
				...
				// // Imgproc.rectangle(mat, new Point(bb.x, bb.y),
				// new
			...
			// SmartDashboard.putString("DB/String 9", "goodRect " +
			// goodRectCounter);
			...
			if (goodRectCounter == 2) {
				...
				if (((bb1.y - bb2.y) > -10 && (bb1.y - bb2.y) < 10)) {
					...
					// "height " +
					// height);
					// SmartDashboard.putString("DB/String 4", "distance " +
					// distanceH);
				}
			}
			...
			// SmartDashboard.putString("DB/String 1", "num rect = " +
